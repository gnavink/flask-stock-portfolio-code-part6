...
class Config(object):
    ...
    DEBUG = False
    TESTING = False
    SECRET_KEY = os.getenv('SECRET_KEY', default='a6e149a67347cc9d6cc6e713b9d538bd69edbf933453d987d354bd5e20805811')
...
class ProductionConfig(Config):
    ...
    DEBUG     =  True # Temporarily enabling debug in production environment
